...
if __name__ == '__main__':
    ...
    data_path = os.path.join(current_dir, 'data', args.data if 'data' in args else args.data)
    working_data_path = os.path.join(WORKING_DIR, 'data', args.data if 'data' in args else args.data)
